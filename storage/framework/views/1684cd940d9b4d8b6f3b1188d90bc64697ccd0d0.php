                                ...
                                <ul class="form-group">
                                    ...
                                    <li>
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control md" name="company" placeholder="<?php echo e(__('例）カーポート株式会社')); ?>">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-group">
                                            <label for="name" class="label"><?php echo e(__('設置場所')); ?></label>
                                            <input type="text" class="form-control xs" name="address" placeholder="<?php echo e(__('例）茨城県水戸市千波町1950 ウェーブ21ビル2F')); ?>">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-group">
                                            <label for="phone" class="label"><?php echo e(__('電話番号')); ?></label>
                                            <input type="text" class="form-control sm" name="phone" placeholder="<?php echo e(__('例）029-303-8581')); ?>">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-group">
                                ...
                                <ul class="form-group">
                                    <li>
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control md" name="bill_name" placeholder="<?php echo e(__('例）カーポート株式会社')); ?>">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-group">
                                            <label for="bill_zipcode" class="label"><?php echo e(__('請求先郵便番号')); ?></label>
                                            <input type="text" class="form-control sd" name="bill_zipcode" placeholder="<?php echo e(__('例）310-0851')); ?>">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-group">
                                            <label for="bill_address1" class="label"><?php echo e(__('請求先住所1')); ?></label>
                                            <input type="text" class="form-control xs" name="bill_address1" placeholder="<?php echo e(__('例）茨城県水戸市千波町1950')); ?>">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-group">
                                            <label for="bill_address2" class="label"><?php echo e(__('請求先住所2')); ?></label>
                                            <input type="text" class="form-control xs" name="bill_address2" placeholder="<?php echo e(__('例）ウェーブ21ビル2F')); ?>">
                                        </div>
                                    </li>
                                </ul>
                            </div>
...
</div><?php /**PATH E:\xampp\htdocs\carport-club\resources\views/modals/modal-carport-new.blade.php ENDPATH**/ ?>