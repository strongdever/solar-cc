...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <link rel="shortcut icon" href="<?php echo e(asset('assets/img/favicon.svg')); ?>">
        <link rel="icon" type="image/png" href="<?php echo e(asset('assets/img/favicon.svg')); ?>">
        <link rel="apple-touch-icon" type="image/png" href="<?php echo e(asset('assets/img/favicon.svg')); ?>">
...
<?php /**PATH E:\xampp\htdocs\solar-cc\resources\views/layouts/app.blade.php ENDPATH**/ ?>