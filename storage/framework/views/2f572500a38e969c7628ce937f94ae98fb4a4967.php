      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <ul class="btn-group">
            ...
            <li>
              <?php echo Form::button('<i class="fa fa-fw '.trans('modals.confirm_modal_button_change_icon').'" aria-hidden="true"></i> ' . trans('modals.confirm_modal_button_change_text'), array('class' => 'form-btn btn-success btn-flat', 'type' => 'button', 'id' => 'confirm' )); ?>
...
<?php /**PATH E:\WORK(2022)\SuzukiWork\11-3(Laravel)\WORK\laravel-auth\resources\views/modals/modal-change.blade.php ENDPATH**/ ?>