    ...
    <table class="table table-sm table-striped data-table permissions-table">
        ...
        <thead class="thead">
            <tr>
                ...
                <th scope="col" class="hidden-xs" width="180px">
                    <?php echo trans('laravelroles::laravelroles.permissions-table.desc'); ?>

                </th>
                <th scope="col" class="hidden-xs hidden-sm" width="90px">
...
<?php /**PATH E:\SuzukiWork\2023-02-28(laravel)\WORK\laravel-auth\vendor\jeremykenedy\laravel-roles\src/resources/views//laravelroles/tables/permission-items-table.blade.php ENDPATH**/ ?>