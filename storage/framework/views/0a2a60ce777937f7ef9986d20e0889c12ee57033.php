    ...
    <div class="container">
      <div class="common-form-wrapper">
        ...
        <div class="common-caption">
          ...
          <ul class="actions">
            <li>
              <a class="btn btn-secondary text-white" href="<?php echo e(url('/myproducts/create')); ?>">
                <?php echo trans('product.buttons.create'); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\WORK(2022)\SuzukiWork\11-3(Laravel)\WORK\laravel-auth\resources\views/pages/user/show-myproducts.blade.php ENDPATH**/ ?>