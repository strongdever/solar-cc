...
<?php $__env->startSection('template_title'); ?>
  <?php echo trans('usersmanagement.editing-user'); ?>
    ...
    <div class="container">
      <div class="common-form-wrapper">
        ...
        <div class="common-caption">
          <h3 class="label y-padding"><?php echo trans('usersmanagement.editing-user'); ?></h3>
          <ul class="actions">
            <li>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\WORK(2022)\SuzukiWork\11-3(Laravel)\WORK\laravel-auth\resources\views/usersmanagement/edit-user.blade.php ENDPATH**/ ?>