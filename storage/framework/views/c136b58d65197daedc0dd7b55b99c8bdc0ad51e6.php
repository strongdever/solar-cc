                ...
                <?php $__currentLoopData = $blocked; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blockedItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td class="hidden-xs hidden-sm hidden-md">
                            <?php echo $blockedItem->created_at->format('Y年m月d日 H:i'); ?>

                        </td>
                        <td class="hidden-xs hidden-sm hidden-md">
                            <?php echo $blockedItem->updated_at->format('Y年m月d日 H:i'); ?>

                        </td>
                        <?php if($tabletype == 'deleted'): ?>
                            <td class="hidden-xs hidden-sm">
                                <?php echo $blockedItem->deleted_at->format('Y年m月d日 H:i'); ?>

                            </td>
                        <?php endif; ?>
                        <?php if($tabletype == 'normal'): ?>
                            <td class="action-td">
                                <a class="btn btn-sm btn-success btn-block text-white" href="/blocker/<?php echo e($blockedItem->id); ?>" data-toggle="tooltip" title="<?php echo e(trans("laravelblocker::laravelblocker.tooltips.show")); ?>">
                                    <?php echo trans("laravelblocker::laravelblocker.buttons.show"); ?>

                                </a>
                            </td>
                            <td class="action-td">
                                <a class="btn btn-sm btn-info btn-block text-white" href="/blocker/<?php echo e($blockedItem->id); ?>/edit" data-toggle="tooltip" title="<?php echo e(trans("laravelblocker::laravelblocker.tooltips.edit")); ?>">
...
<?php /**PATH E:\WORK(2022)\SuzukiWork\11-3(Laravel)\WORK\laravel-auth\vendor\jeremykenedy\laravel-blocker\src/resources/views//partials/blocked-items-table.blade.php ENDPATH**/ ?>