                ...
                success: function (result) {
                    ...
                    if (jsonData.length != 0) {
                        $.each(jsonData, function(index, val) {
                            ...
                            var excerpt = val.note.length > 20 ? val.note.substr(0, 20) + '...' : val.note;

                            resultsContainer.append('<tr>' +
                                '<td>' + val.id + '</td>' +
                                '<td>' + val.type + '</td>' +
                                '<td>' + val.value + '</td>' +
                                '<td class="hidden-xs">' + excerpt + '</td>' +
...
<?php /**PATH E:\SuzukiWork\2023-02-28(laravel)\WORK\laravel-auth\vendor\jeremykenedy\laravel-blocker\src/resources/views//scripts/search-blocked.blade.php ENDPATH**/ ?>