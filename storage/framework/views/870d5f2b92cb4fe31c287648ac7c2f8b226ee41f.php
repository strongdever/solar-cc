                        ...
                        <table class="form-table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-input">
                                            <input type="text" class="form-control<?php echo e($errors->has('company') ? ' is-invalid' : ''); ?>" name="company" value="<?php echo e(old('company')); ?>" placeholder="<?php echo e(__('例）株式会社株式会社ティーエムユニオン')); ?>">
