                                ...
                                <ul class="form-group">
                                    <li>
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control ss" name="uuid" placeholder="<?php echo e(__('例）10001')); ?>">
                                    ...
                                    <li>
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control md" name="company" placeholder="<?php echo e(__('例）株式会社カーポートソーラーシステム')); ?>">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-group">
                                            <label for="name" class="label"><?php echo e(__('設置場所')); ?></label>
                                            <input type="text" class="form-control xs" name="address" placeholder="<?php echo e(__('例）東京都新宿区西新宿2-8-1 西新宿ビル1階')); ?>">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-group">
                                            <label for="phone" class="label"><?php echo e(__('電話番号')); ?></label>
                                            <input type="text" class="form-control sm" name="phone" placeholder="<?php echo e(__('例）03-1234-5678')); ?>">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-group">
                                            <label for="email" class="label"><?php echo e(__('メールアドレス')); ?></label>
                                            <input type="email" class="form-control md" name="email" placeholder="<?php echo e(__('例）info@example.com')); ?>">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-group">
                                            <label for="manager" class="label"><?php echo e(__('担当者')); ?></label>
                                            <input type="text" class="form-control md" name="manager" placeholder="<?php echo e(__('例）山田太郎')); ?>">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-group">
                                ...
                                <ul class="form-group">
                                    <li>
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control md" name="bill_name" placeholder="<?php echo e(__('例）株式会社カーポートソーラーシステム')); ?>">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-group">
                                            <label for="bill_zipcode" class="label"><?php echo e(__('請求先郵便番号')); ?></label>
                                            <input type="text" class="form-control sd" name="bill_zipcode" placeholder="<?php echo e(__('例）123-4567')); ?>">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-group">
                                            <label for="bill_address1" class="label"><?php echo e(__('請求先住所1')); ?></label>
                                            <input type="text" class="form-control xs" name="bill_address1" placeholder="<?php echo e(__('例）東京都新宿区西新宿2-8-1')); ?>">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-group">
                                            <label for="bill_address2" class="label"><?php echo e(__('請求先住所2')); ?></label>
                                            <input type="text" class="form-control xs" name="bill_address2" placeholder="<?php echo e(__('例）西新宿ビル1階')); ?>">
                                        </div>
                                    </li>
                                </ul>
                            </div>
...
</div><?php /**PATH E:\xampp\htdocs\solar-cc\resources\views/modals/modal-carport-new.blade.php ENDPATH**/ ?>