<div class="common-form">
    <form action="<?php echo e(route('laravelroles::permissions.store')); ?>" method="POST" accept-charset="utf-8" id="store_permission_form" class="mb-0 needs-validation" enctype="multipart/form-data" role="form" >
        ...
        <ul class="btn-group form-bottom">
            <li>
                <button type="submit" class="btn btn-success btn-block" value="save" name="action">
...
<?php /**PATH E:\WORK(2022)\SuzukiWork\11-3(Laravel)\WORK\laravel-auth\vendor\jeremykenedy\laravel-roles\src/resources/views//laravelroles/forms/create-permission-form.blade.php ENDPATH**/ ?>