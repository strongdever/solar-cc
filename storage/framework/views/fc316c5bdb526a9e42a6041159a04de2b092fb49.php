...
<section class="l_lead_section">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-lg-4 mb_30">
                <ul class="list-group">
                    <li class="list-group-item <?php if($isClearedEntry): ?> list-group-item-danger <?php else: ?> active <?php endif; ?>">
        ...
        <div class="scroll">
            <?php if(!$isClearedEntry): ?>
                <div class="common-caption mb_20">
                    <h3 class="label y-padding">
...
<?php echo $__env->make(config('LaravelLogger.loggerBladeExtended'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\WORK(2022)\SuzukiWork\11-3(Laravel)\WORK\laravel-auth\vendor\jeremykenedy\laravel-logger\src/resources/views//logger/activity-log-item.blade.php ENDPATH**/ ?>