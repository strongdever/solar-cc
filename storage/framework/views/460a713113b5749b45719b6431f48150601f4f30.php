    ...
    <table class="table table-sm table-striped data-table roles-table">
        ...
        <thead class="thead">
            <tr>
                ...
                <th scope="col" class="hidden-xs hidden-sm" width="<?php echo e($tabletype == 'deleted' ? '200px' : '290px'); ?>">
...
<?php /**PATH E:\WORK(2022)\SuzukiWork\11-3(Laravel)\WORK\laravel-auth\vendor\jeremykenedy\laravel-roles\src/resources/views//laravelroles/tables/role-items-table.blade.php ENDPATH**/ ?>