                ...
                <div class="common-form">
                    ...
                    <ul class="btn-group form-bottom">
                        <li>
                            ...
                            <?php else: ?>
                                <a class="form-btn btn-info btn-block text-white mb-0" href="<?php echo e(route('laravelroles::roles.edit', $item->id)); ?>">
...
<?php echo $__env->make(config('roles.bladeExtended'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\WORK(2022)\SuzukiWork\11-3(Laravel)\WORK\laravel-auth\vendor\jeremykenedy\laravel-roles\src/resources/views//laravelroles/crud/roles/show.blade.php ENDPATH**/ ?>