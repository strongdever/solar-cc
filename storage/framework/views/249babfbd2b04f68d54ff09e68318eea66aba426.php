        ...
        <div class="common-form">
            <div class="form-card mb-40 mb-sp-30">
                <?php echo Form::open(array('route' => ['stores.update', $user->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'form needs-validation')); ?>
                    ...
                    <h3 class="card-title"><?php echo e(__('販売店情報変更')); ?></h3>
                    <div class="card-body">
                        ...
                        <table class="form-table">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-input">
                                            <input type="text" class="form-control<?php echo e($errors->has('uuid') ? ' is-invalid' : ''); ?>" name="uuid" value="<?php echo e($user->uuid); ?>" placeholder="<?php echo e(__('carport123')); ?>" autofocus>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-input">
                                            <input type="text" class="form-control<?php echo e($errors->has('company') ? ' is-invalid' : ''); ?>" name="company" value="<?php echo e($user->company); ?>" placeholder="<?php echo e(__('株式会社ニンニンドットコム')); ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-input">
                                            <input type="text" class="form-control<?php echo e($errors->has('zipcode') ? ' is-invalid' : ''); ?>" name="zipcode" value="<?php echo e($user->zipcode); ?>" placeholder="<?php echo e(__('151-0072')); ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-input">
                                            <input type="text" class="form-control<?php echo e($errors->has('address1') ? ' is-invalid' : ''); ?>" name="address1" value="<?php echo e($user->address1); ?>" placeholder="<?php echo e(__('東京都渋谷区幡谷5-2-3')); ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-input">
                                            <input type="text" class="form-control<?php echo e($errors->has('address2') ? ' is-invalid' : ''); ?>" name="address2" value="<?php echo e($user->address2); ?>" placeholder="<?php echo e(__('東京都渋谷区幡谷5-2-3')); ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-input">
                                            <input type="tel" class="form-control<?php echo e($errors->has('phone') ? ' is-invalid' : ''); ?>" name="phone" value="<?php echo e($user->phone); ?>" placeholder="<?php echo e(__('080-5503-9363')); ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-input">
                                            <input type="email" class="form-control<?php echo e($errors->has('email') ? ' is-invalid' : ''); ?>" name="email" value="<?php echo e($user->email); ?>" placeholder="<?php echo e(__('carport1234@gmail.com')); ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-input">
                                            <input type="text" class="form-control<?php echo e($errors->has('name') ? ' is-invalid' : ''); ?>" name="name" value="<?php echo e($user->name); ?>" placeholder="<?php echo e(__('山田太郎')); ?>">
                        ...
                        <table class="form-table">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-input">
                                            <input type="text" class="form-control<?php echo e($errors->has('bank_name') ? ' is-invalid' : ''); ?>" name="bank_name" value="<?php echo e($user->bank->name); ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-input">
                                            <input type="text" class="form-control<?php echo e($errors->has('bank_branch') ? ' is-invalid' : ''); ?>" name="bank_branch" value="<?php echo e($user->bank->branch); ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-input">
                                            <input type="text" class="form-control<?php echo e($errors->has('bank_kind') ? ' is-invalid' : ''); ?>" name="bank_kind" value="<?php echo e($user->bank->kind); ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-input">
                                            <input type="text" class="form-control<?php echo e($errors->has('bank_number') ? ' is-invalid' : ''); ?>" name="bank_number" value="<?php echo e($user->bank->number); ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-input">
                                            <input type="text" class="form-control<?php echo e($errors->has('bank_holder') ? ' is-invalid' : ''); ?>" name="bank_holder" value="<?php echo e($user->bank->holder); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\SuzukiWork\2023-02-28(laravel)\WORK\laravel-auth\resources\views/usersmanagement/edit-user.blade.php ENDPATH**/ ?>