                ...
                <div class="form-card card-sm mb-40 mb-sp-30">
                    <div class="card-body">
                        <ul class="form-group">
                            ...
                            <li>
                                <div class="input-group">
                                    <label for="unit_price" class="label"><?php echo e(__('自家消費分販売電力単価')); ?></label>
...
<?php echo Form::close(); ?><?php /**PATH E:\SuzukiWork\2023-02-28(laravel)\WORK\laravel-auth\resources\views/modals/carport-detail-template.blade.php ENDPATH**/ ?>