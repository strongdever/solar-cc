<script>
    $(function() {
        ...
        searchform.submit(function(e) {
            ...
            let noResulsHtml = '<tr>' +
                                '<td colspan="6" class="no-result"><?php echo e(__("検索結果がありません。")); ?></td>' +
                                '</tr>';

            $.ajax({
                type:'POST',
                url: "<?php echo e(route('search-carport')); ?>",
                ...
                success: function (result) {
                    ...
                    if (jsonData.length != 0) {
                        $.each(jsonData, function(index, val) {
                            let rolesHtml = '';
                            let roleClass = '';
                            let detailCellHtml = '<button class="btn btn-sm btn-info btn-outline caportDetailModalLink" data-id="'+val.id+'" data-target="#carportDetailModal" data-toggle="modal"><?php echo e(__("詳細")); ?></button>';
...
<?php /**PATH E:\SuzukiWork\2023-02-28(laravel)\WORK\laravel-auth\resources\views/scripts/search-carports.blade.php ENDPATH**/ ?>