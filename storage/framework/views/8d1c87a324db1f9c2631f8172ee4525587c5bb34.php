...
<?php $__env->startSection('content'); ?>
    ...
    <div class="dashboard-card">
        <div class="common-caption">
            <h3 class="label y-padding"><?php echo trans('laravelblocker::laravelblocker.edit-blocked-item-title'); ?></h3>
            <ul class="actions">
                <li>
...
<?php echo $__env->make(config('laravelblocker.laravelBlockerBladeExtended'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\SuzukiWork\2023-02-28(laravel)\WORK\laravel-auth\vendor\jeremykenedy\laravel-blocker\src/resources/views//laravelblocker/edit.blade.php ENDPATH**/ ?>