                        ...
                        <ul class="form-group">
                            ...
                            <li>
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control sd<?php echo e($errors->has('zipcode') ? ' is-invalid' : ''); ?>" name="zipcode" value="<?php echo e($user->zipcode); ?>" placeholder="例）123-4567">
                                ...
                                <div class="form-row">
                                    <div class="form-col">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control sm<?php echo e($errors->has('address1') ? ' is-invalid' : ''); ?>" name="address1" value="<?php echo e($user->address1); ?>" placeholder="例）東京都新宿区西新宿2-8-1">
                                    ...
                                    <div class="form-col">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control sm<?php echo e($errors->has('address2') ? ' is-invalid' : ''); ?>" name="address2" value="<?php echo e($user->address2); ?>" placeholder="例）西新宿ビル1階">
                            ...
                            <li>
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control sm<?php echo e($errors->has('phone') ? ' is-invalid' : ''); ?>" name="phone" value="<?php echo e($user->phone); ?>" placeholder="例）03-1234-5678">
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\solar-cc\resources\views/profiles/show.blade.php ENDPATH**/ ?>