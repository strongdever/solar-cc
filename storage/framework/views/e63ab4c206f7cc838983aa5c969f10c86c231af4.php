                        ...
                        <ul class="form-group">
                            ...
                            <li>
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control md<?php echo e($errors->has('company') ? ' is-invalid' : ''); ?>" name="company" value="<?php echo e($user->company); ?>" placeholder="株式会社ニンニンドットコム" autofocus>
                            ...
                            <li>
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control sd<?php echo e($errors->has('zipcode') ? ' is-invalid' : ''); ?>" name="zipcode" value="<?php echo e($user->zipcode); ?>" placeholder="151-0072">
                                ...
                                <div class="form-row">
                                    <div class="form-col">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control sm<?php echo e($errors->has('address1') ? ' is-invalid' : ''); ?>" name="address1" value="<?php echo e($user->address1); ?>" placeholder="東京都渋谷区幡谷5-2-3">
                                    ...
                                    <div class="form-col">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control sm<?php echo e($errors->has('address2') ? ' is-invalid' : ''); ?>" name="address2" value="<?php echo e($user->address2); ?>" placeholder="東京都渋谷区幡谷5-2-3">
                            ...
                            <li>
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control sm<?php echo e($errors->has('phone') ? ' is-invalid' : ''); ?>" name="phone" value="<?php echo e($user->phone); ?>" placeholder="080-5503-9363">
                            ...
                            <li>
                                <div class="input-group">
                                    ...
                                    <input type="email" class="form-control md<?php echo e($errors->has('email') ? ' is-invalid' : ''); ?>" name="email" value="<?php echo e($user->email); ?>" placeholder="carport1234@gmail.com">
                            ...
                            <li>
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control sm<?php echo e($errors->has('name') ? ' is-invalid' : ''); ?>" name="name" value="<?php echo e($user->name); ?>" placeholder="山田太郎">
                        ...
                        <ul class="form-group">
                            <li>
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control sm<?php echo e($errors->has('name') ? ' is-invalid' : ''); ?>" name="name" value="<?php echo e($user->bank->name); ?>">
                                    <?php if($errors->has('name')): ?>
                                        <p class="invalid-feedback"><?php echo e($errors->first('name')); ?></p>
                                    <?php endif; ?>
                                </div>
                            ...
                            <li>
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control sd<?php echo e($errors->has('branch') ? ' is-invalid' : ''); ?>" name="branch" value="<?php echo e($user->bank->branch); ?>">
                            ...
                            <li>
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control sd<?php echo e($errors->has('kind') ? ' is-invalid' : ''); ?>" name="kind" value="<?php echo e($user->bank->kind); ?>">
                            ...
                            <li>
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control sm<?php echo e($errors->has('number') ? ' is-invalid' : ''); ?>" name="number" value="<?php echo e($user->bank->number); ?>">
                            ...
                            <li>
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control sm<?php echo e($errors->has('holder') ? ' is-invalid' : ''); ?>" name="holder" value="<?php echo e($user->bank->holder); ?>">
                        ...
                        <ul class="form-group">
                            <li>
                                <div class="input-group">
                                    ...
                                    <input type="password" class="form-control sm<?php echo e($errors->has('old_password') ? ' is-invalid' : ''); ?>" name="old_password" value="<?php echo e(old('old_password')); ?>" placeholder="carport123">
                            ...
                            <li>
                                <div class="input-group">
                                    ...
                                    <input type="password" class="form-control sm<?php echo e($errors->has('password') ? ' is-invalid' : ''); ?>" name="password" value="<?php echo e(old('password')); ?>" placeholder="carport123">
                            ...
                            <li>
                                <div class="input-group">
                                    ...
                                    <input type="password" class="form-control sm<?php echo e($errors->has('password_confirmation') ? ' is-invalid' : ''); ?>" name="password_confirmation" value="<?php echo e(old('password_confirmation')); ?>" placeholder="carport123">
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\SuzukiWork\2023-02-28(laravel)\WORK\laravel-auth\resources\views/profiles/show.blade.php ENDPATH**/ ?>