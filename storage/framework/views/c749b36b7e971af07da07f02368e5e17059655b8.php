...
<?php $__env->startSection('template_title'); ?>
  <?php echo trans('profile.profile-menu-alt'); ?>
    ...
    <div class="container">
      <div class="common-form-wrapper">
        ...
        <div class="common-caption">
          <h3 class="label"><?php echo trans('profile.profile-menu-alt'); ?></h3>
        </div>
            ...
            <div class="row">
              ...
              <div class="col-sm-4 col-md-5">
                ...
                <?php if($user->profile): ?>
                  <ul class="actions">
                    <li>
                      <a href="<?php echo e(url('profile/' . $user->name) . '/edit'); ?>" class="btn form-btn btn-basic btn-ms text-white">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\WORK(2022)\SuzukiWork\11-3(Laravel)\WORK\laravel-auth\resources\views/profiles/show.blade.php ENDPATH**/ ?>