                    ...
                    <li>
                        <?php if($deletedBlockedItems->count() > 0): ?>
                            <div class="btn-group btn-group-xs">
                                <button type="button" class="btn btn-secondary text-white dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <?php else: ?>
                            <a class="btn form-btn btn-secondary" href="<?php echo e(route('laravelblocker::blocker.create')); ?>">
                                <i class="fa fa-fw fa-plus" aria-hidden="true"></i>
                                <?php echo trans('laravelblocker::laravelblocker.buttons.create-new-blocked'); ?>
...
<?php echo $__env->make(config('laravelblocker.laravelBlockerBladeExtended'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\WORK(2022)\SuzukiWork\11-3(Laravel)\WORK\laravel-auth\vendor\jeremykenedy\laravel-blocker\src/resources/views//laravelblocker/index.blade.php ENDPATH**/ ?>