            ...
            <div class="common-form-wrapper">
                <div class="common-caption">
                    <h3 class="label y-padding">
                        <?php echo trans('laravelroles::laravelroles.titles.edit-permission', ['name' => $name]); ?>
                ...
                <?php echo $__env->make('laravelroles::laravelroles.forms.edit-permission-form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    </section>
...
<?php echo $__env->make(config('roles.bladeExtended'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\WORK(2022)\SuzukiWork\11-3(Laravel)\WORK\laravel-auth\vendor\jeremykenedy\laravel-roles\src/resources/views//laravelroles/crud/permissions/edit.blade.php ENDPATH**/ ?>