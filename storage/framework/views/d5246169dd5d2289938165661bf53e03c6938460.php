        ...
        <div class="common-form">
            <?php echo Form::open(array('route' => 'stores.store', 'method' => 'POST', 'role' => 'form', 'class' => 'form needs-validation')); ?>
                        ...
                        <table class="form-table">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-input">
                                            <input type="text" class="form-control<?php echo e($errors->has('uuid') ? ' is-invalid' : ''); ?>" name="uuid" value="<?php echo e(old('uuid')); ?>" placeholder="<?php echo e(__('carport123')); ?>" autofocus>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-input">
                                            <input type="text" class="form-control<?php echo e($errors->has('company') ? ' is-invalid' : ''); ?>" name="company" value="<?php echo e(old('company')); ?>" placeholder="<?php echo e(__('株式会社ニンニンドットコム')); ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-input">
                                            <input type="text" class="form-control<?php echo e($errors->has('zipcode') ? ' is-invalid' : ''); ?>" name="zipcode" value="<?php echo e(old('zipcode')); ?>" placeholder="<?php echo e(__('151-0072')); ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-input">
                                            <input type="text" class="form-control<?php echo e($errors->has('address1') ? ' is-invalid' : ''); ?>" name="address1" value="<?php echo e(old('address1')); ?>" placeholder="<?php echo e(__('東京都渋谷区幡谷5-2-3')); ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-input">
                                            <input type="text" class="form-control<?php echo e($errors->has('address2') ? ' is-invalid' : ''); ?>" name="address2" value="<?php echo e(old('address2')); ?>" placeholder="<?php echo e(__('東京都渋谷区幡谷5-2-3')); ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-input">
                                            <input type="tel" class="form-control<?php echo e($errors->has('phone') ? ' is-invalid' : ''); ?>" name="phone" value="<?php echo e(old('phone')); ?>" placeholder="<?php echo e(__('080-5503-9363')); ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-input">
                                            <input type="email" class="form-control<?php echo e($errors->has('email') ? ' is-invalid' : ''); ?>" name="email" value="<?php echo e(old('email')); ?>" placeholder="<?php echo e(__('carport1234@gmail.com')); ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-input">
                                            <input type="text" class="form-control<?php echo e($errors->has('name') ? ' is-invalid' : ''); ?>" name="name" value="<?php echo e(old('name')); ?>" placeholder="<?php echo e(__('山田太郎')); ?>">
                        ...
                        <table class="form-table">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-input">
                                            <input type="text" class="form-control<?php echo e($errors->has('bank_name') ? ' is-invalid' : ''); ?>" name="bank_name" value="<?php echo e(old('bank_name')); ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-input">
                                            <input type="text" class="form-control<?php echo e($errors->has('bank_branch') ? ' is-invalid' : ''); ?>" name="bank_branch" value="<?php echo e(old('bank_branch')); ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-input">
                                            <input type="text" class="form-control<?php echo e($errors->has('bank_kind') ? ' is-invalid' : ''); ?>" name="bank_kind" value="<?php echo e(old('bank_kind')); ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-input">
                                            <input type="text" class="form-control<?php echo e($errors->has('bank_number') ? ' is-invalid' : ''); ?>" name="bank_number" value="<?php echo e(old('bank_number')); ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-input">
                                            <input type="text" class="form-control<?php echo e($errors->has('bank_holder') ? ' is-invalid' : ''); ?>" name="bank_holder" value="<?php echo e(old('bank_holder')); ?>">
                ...
                <ul class="btn-group form-bottom">
                    <li>
                        <?php echo Form::button(trans('usersmanagement.buttons.create-alt'), array('class' => 'btn form-btn btn-success','type' => 'submit' )); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\SuzukiWork\2023-02-28(laravel)\WORK\laravel-auth\resources\views/usersmanagement/create-user.blade.php ENDPATH**/ ?>