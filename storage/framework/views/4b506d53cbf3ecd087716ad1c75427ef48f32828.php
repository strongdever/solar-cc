                                    ...
                                    <table class="bill-table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><?php echo '¥'.number_format( $powerInvoiceItem->carport->unit_price, 0 ); ?></td>
                                                <td><?php echo '¥'.number_format( intval( $powerInvoiceItem->carport->unit_price * $powerInvoiceItem->used_amount ), 0 ); ?></td>
                                            </tr>
                                            <?php
                                                $totalPrice += $powerInvoiceItem->carport->unit_price * $powerInvoiceItem->used_amount;
                                            ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo '¥'.number_format( $feeItem->value, 0 ); ?></td>
                                                <td><?php echo '¥'.number_format( $feeItem->value * 1, 0 ); ?></td>
                                            </tr>
                                            <?php
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td></td>
                                                <td><?php echo '¥'.number_format( intval( $totalPrice ), 0 ); ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
...
</div><?php /**PATH E:\SuzukiWork\2023-02-28(laravel)\WORK\laravel-auth\resources\views/modals/modal-invoice.blade.php ENDPATH**/ ?>