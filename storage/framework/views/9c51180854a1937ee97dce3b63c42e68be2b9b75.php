    ...
    <div class="header_wrapper clearfix">
      ...
      <nav class="nav_menu_container">
        <ul class="nav_menu">
          <?php if(auth()->guard()->check()): ?>
            ...
            <li class="dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="<?php echo e(url('/categories')); ?>">カテゴリ管理</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="<?php echo e(url('/areas')); ?>">対応地域管理</a>
                <div class="dropdown-divider"></div>
          ...
          <li>
            <a href="<?php echo e(route('myproducts.create')); ?>">
              <span>譲りたいアイテムを登録する</span>
            </a>
          </li>
          <li>
            <a href="<?php echo e(route('watchlists')); ?>">
          ...
          <?php if(auth()->guard()->check()): ?>
            <li>
              <a href="<?php echo e(url('/profile/'. Auth::user()->name)); ?>">
                <span>マイページ</span>
              </a>
            </li>
            <li>
...
</div><?php /**PATH E:\WORK(2022)\SuzukiWork\11-3(Laravel)\WORK\laravel-auth\resources\views/partials/nav.blade.php ENDPATH**/ ?>