...
<?php $__env->startSection('content'); ?>
    ...
    <div class="dashboard-card">
        <div class="common-caption">
            <h3 class="label y-padding"><?php echo trans('contract_type.titles.edit-alt'); ?></h3>
            <ul class="actions">
                <li>
		...
		<div class="form-card">
	        <div class="common-form">
	            <?php echo Form::open(array('route' => ['contract_types.update', $contract_type->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'needs-validation')); ?>
		            ...
		            <ul class="btn-group form-bottom">
		                <li>
		                    <?php echo Form::button(trans('forms.save-changes'), array('class' => 'btn form-btn btn-success btn-block text-white btn-save','type' => 'button', 'data-toggle' => 'modal', 'data-target' => '#confirmSave', 'data-title' => trans('contract_type.modals.confirm_title'), 'data-message' => trans('contract_type.modals.confirm_message'))); ?>
...
<?php $__env->startSection('footer_scripts'); ?>
	...
	<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\SuzukiWork\2023-02-28(laravel)\WORK\laravel-auth\resources\views/contract_types/edit.blade.php ENDPATH**/ ?>