                        ...
                        <table class="form-table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-input">
                                            <input type="text" class="form-control<?php echo e($errors->has('zipcode') ? ' is-invalid' : ''); ?>" name="zipcode" value="<?php echo e($user->zipcode); ?>" placeholder="<?php echo e(__('例）123-4567')); ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-input">
                                            <input type="text" class="form-control<?php echo e($errors->has('address1') ? ' is-invalid' : ''); ?>" name="address1" value="<?php echo e($user->address1); ?>" placeholder="<?php echo e(__('例）東京都新宿区西新宿2-8-1')); ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-input">
                                            <input type="text" class="form-control<?php echo e($errors->has('address2') ? ' is-invalid' : ''); ?>" name="address2" value="<?php echo e($user->address2); ?>" placeholder="<?php echo e(__('例）西新宿ビル1階')); ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-input">
                                            <input type="tel" class="form-control<?php echo e($errors->has('phone') ? ' is-invalid' : ''); ?>" name="phone" value="<?php echo e($user->phone); ?>" placeholder="<?php echo e(__('例）03-1234-5678')); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\solar-cc\resources\views/usersmanagement/edit-user.blade.php ENDPATH**/ ?>