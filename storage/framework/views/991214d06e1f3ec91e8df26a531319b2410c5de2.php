<?php echo Form::open([
    ...
    <div class="form-card">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-input">
                            <?php if(isset($item)): ?>
                                <input type="text" class="form-control<?php echo e($errors->has('value') ? ' is-invalid' : ''); ?>" name="value" value="<?php echo $item->value; ?>" placeholder="<?php echo trans('laravelblocker::laravelblocker.forms.blockedValuePH'); ?>" autofocus>
                            <?php else: ?>
                                <input type="text" class="form-control<?php echo e($errors->has('value') ? ' is-invalid' : ''); ?>" name="value" value="<?php echo e(old('value')); ?>" placeholder="<?php echo trans('laravelblocker::laravelblocker.forms.blockedValuePH'); ?>" autofocus>
                            <?php endif; ?>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-input">
                            <?php if(isset($item)): ?>
                                <textarea class="form-control<?php echo e($errors->has('note') ? ' is-invalid' : ''); ?>" name="note" value="<?php echo $item->note; ?>" id="note" rows="8" placeholder="<?php echo trans('laravelblocker::laravelblocker.forms.blockedNotePH'); ?>"></textarea>
                            <?php else: ?>
                                <textarea class="form-control<?php echo e($errors->has('note') ? ' is-invalid' : ''); ?>" name="note" value="<?php echo e(old('note')); ?>" id="note" rows="8" placeholder="<?php echo trans('laravelblocker::laravelblocker.forms.blockedNotePH'); ?>"></textarea>
                            <?php endif; ?>
        ...
        <ul class="btn-group form-bottom">
            <li>
                <?php echo Form::button(trans('laravelblocker::laravelblocker.buttons.create-larger'), array('class' => 'btn form-btn btn-success btn-block','type' => 'submit' )); ?>
...
<?php /**PATH E:\SuzukiWork\2023-02-28(laravel)\WORK\laravel-auth\vendor\jeremykenedy\laravel-blocker\src/resources/views//forms/create-new.blade.php ENDPATH**/ ?>