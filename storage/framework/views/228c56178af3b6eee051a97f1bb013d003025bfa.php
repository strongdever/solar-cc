                                ...
                                <ul class="form-group">
                                    ...
                                    <li>
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control md" name="company" placeholder="<?php echo e(__('例）株式会社カーポートソーラーシステム')); ?>" value="<?php echo $carport->company; ?>">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-group">
                                            <label for="address" class="label"><?php echo e(__('設置場所')); ?></label>
                                            <input type="text" class="form-control xs" name="address" placeholder="<?php echo e(__('例）東京都新宿区西新宿2-8-1 西新宿ビル1階')); ?>" value="<?php echo $carport->address; ?>">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-group">
                                            <label for="phone" class="label"><?php echo e(__('電話番号')); ?></label>
                                            <input type="text" class="form-control sm" name="phone" placeholder="<?php echo e(__('例）03-1234-5678')); ?>" value="<?php echo $carport->phone; ?>">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-group">
                                ...
                                <ul class="form-group">
                                    <li>
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control md" name="bill_name" placeholder="<?php echo e(__('例）株式会社カーポートソーラーシステム')); ?>" value="<?php echo $carport->bill->name; ?>">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-group">
                                            <label for="bill_zipcode" class="label"><?php echo e(__('請求先郵便番号')); ?></label>
                                            <input type="text" class="form-control sd" name="bill_zipcode" placeholder="<?php echo e(__('例）123-4567')); ?>" value="<?php echo $carport->bill->zipcode; ?>">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-group">
                                            <label for="bill_address1" class="label"><?php echo e(__('請求先住所1')); ?></label>
                                            <input type="text" class="form-control xs" name="bill_address1" placeholder="<?php echo e(__('例）東京都新宿区西新宿2-8-1')); ?>" value="<?php echo $carport->bill->address1; ?>">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-group">
                                            <label for="bill_address2" class="label"><?php echo e(__('請求先住所2')); ?></label>
                                            <input type="text" class="form-control xs" name="bill_address2" placeholder="<?php echo e(__('例）西新宿ビル1階')); ?>" value="<?php echo $carport->bill->address2; ?>">
                                        </div>
                                    </li>
                                </ul>
                            </div>
...
</div><?php /**PATH E:\xampp\htdocs\solar-cc\resources\views/modals/modal-carport-detail.blade.php ENDPATH**/ ?>