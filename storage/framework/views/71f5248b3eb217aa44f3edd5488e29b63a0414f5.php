...
<?php $__env->startSection('content'); ?>
    <div class="dashboard-card mb-50 mb-sp-40">
        ...
        <div class="card-body">
            <div class="description mb-24 mb-sp-20"><?php echo e(__('新規でカーポートができたらこちらから登録を行ってください。')); ?></div>
            <div class="action">
                            ...
                            <?php $__currentLoopData = $powerInvoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $powerInvoiceItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="action">
                                        ...
                                        ?>
                                        <button class="btn btn-sm btn-info btn-outline invoiceDetailModalLink" data-target="#invoiceDetailModal_<?php echo $invoiceUuid; ?>" data-toggle="modal"><?php echo e(__('詳細を確認')); ?></button>
                                    </td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php else: ?>
...
<?php $__env->startSection('footer_scripts'); ?>
    ...
    <?php echo $__env->make('scripts.home-select', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\solar-cc\resources\views/pages/user/home.blade.php ENDPATH**/ ?>