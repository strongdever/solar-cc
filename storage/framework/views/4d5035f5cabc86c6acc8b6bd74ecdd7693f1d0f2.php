                                ...
                                <ul class="form-group">
                                    <li>
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control ss" name="uuid" placeholder="<?php echo e(__('10001')); ?>" value="<?php echo $carport->uuid; ?>">
                                    ...
                                    <li>
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control md" name="company" placeholder="<?php echo e(__('○○○邸発電所')); ?>" value="<?php echo $carport->company; ?>">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-group">
                                            <label for="address" class="label"><?php echo e(__('設置場所')); ?></label>
                                            <input type="text" class="form-control xs" name="address" placeholder="<?php echo e(__('東京都渋谷区幡谷5-2-3')); ?>" value="<?php echo $carport->address; ?>">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-group">
                                            <label for="phone" class="label"><?php echo e(__('電話番号')); ?></label>
                                            <input type="text" class="form-control sm" name="phone" placeholder="<?php echo e(__('080-5503-9363')); ?>" value="<?php echo $carport->phone; ?>">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-group">
                                            <label for="email" class="label"><?php echo e(__('メールアドレス')); ?></label>
                                            <input type="email" class="form-control md" name="email" placeholder="<?php echo e(__('carport1234@gmail.com')); ?>" value="<?php echo $carport->email; ?>">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-group">
                                            <label for="manager" class="label"><?php echo e(__('担当者')); ?></label>
                                            <input type="text" class="form-control md" name="manager" placeholder="<?php echo e(__('山田太郎')); ?>" value="<?php echo $carport->manager; ?>">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-group">
                                ...
                                <ul class="form-group">
                                    <li>
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control md" name="bill_name" placeholder="<?php echo e(__('AAA株式会社')); ?>" value="<?php echo $carport->bill->name; ?>">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-group">
                                            <label for="bill_zipcode" class="label"><?php echo e(__('請求先郵便番号')); ?></label>
                                            <input type="text" class="form-control sd" name="bill_zipcode" placeholder="<?php echo e(__('141-0031')); ?>" value="<?php echo $carport->bill->zipcode; ?>">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-group">
                                            <label for="bill_address1" class="label"><?php echo e(__('請求先住所1')); ?></label>
                                            <input type="text" class="form-control xs" name="bill_address1" placeholder="<?php echo e(__('東京都品川区西五反田1000')); ?>" value="<?php echo $carport->bill->address1; ?>">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-group">
                                            <label for="bill_address2" class="label"><?php echo e(__('請求先住所2')); ?></label>
                                            <input type="text" class="form-control xs" name="bill_address2" placeholder="<?php echo e(__('東京都品川区西五反田1000')); ?>" value="<?php echo $carport->bill->address2; ?>">
                                        </div>
                                    </li>
                                </ul>
                            </div>
...
</div><?php /**PATH E:\SuzukiWork\2023-02-28(laravel)\WORK\laravel-auth\resources\views/modals/modal-carport-detail.blade.php ENDPATH**/ ?>