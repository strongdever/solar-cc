            ...
            <div class="csv-dropzone-upload mb-50 mb-sp-40">
                <form action="<?php echo e(route('dropzone.store')); ?>" method="post" name="file" files="true" enctype="multipart/form-data" class="dropzone" id="csv-dropzone" >
                    ...
                    <div class="dz-message">
                        ...
                        <span class="btn btn-outline"><?php echo e(__('ファイルを選択')); ?></span>
                    </div>
                </form>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\SuzukiWork\2023-02-28(laravel)\WORK\laravel-auth\resources\views/pages/user/power-register.blade.php ENDPATH**/ ?>