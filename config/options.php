...
return [
  ...
  */
  ...
  // Swiper slide
  'swiperCssCDN'                  => 'https://cdn.jsdelivr.net/npm/swiper/swiper-bundle.min.css',
  'swiperJsCDN'                   => 'https://cdn.jsdelivr.net/npm/swiper/swiper-bundle.min.js',

  // List Pagination
  'enablePagination'              => true,
  'paginateListSize'              => env('USER_LIST_PAGINATION_SIZE', 20),

  // List JS DataTables - not recommended use with pagination
  'enabledDatatablesJs'           => false,
  'datatablesJsStartCount'        => 20,
