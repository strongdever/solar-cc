                        ...
                        <table class="form-table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-input">
                                            <input type="text" class="form-control{{ $errors->has('company') ? ' is-invalid' : '' }}" name="company" value="{{ $user->company }}" placeholder="{{ __('例）株式会社カーポートソーラーシステム') }}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-input">
                                            <input type="text" class="form-control{{ $errors->has('zipcode') ? ' is-invalid' : '' }}" name="zipcode" value="{{ $user->zipcode }}" placeholder="{{ __('例）123-4567') }}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-input">
                                            <input type="text" class="form-control{{ $errors->has('address1') ? ' is-invalid' : '' }}" name="address1" value="{{ $user->address1 }}" placeholder="{{ __('例）東京都新宿区西新宿2-8-1') }}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-input">
                                            <input type="text" class="form-control{{ $errors->has('address2') ? ' is-invalid' : '' }}" name="address2" value="{{ $user->address2 }}" placeholder="{{ __('例）西新宿ビル1階') }}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-input">
                                            <input type="tel" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" name="phone" value="{{ $user->phone }}" placeholder="{{ __('例）03-1234-5678') }}">
                                            @if ($errors->has('phone'))
