                        ...
                        <ul class="form-group">
                            <li>
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control ss" name="uuid" placeholder="{{ __('10001') }}" value="{!! $carport->uuid !!}">
                            ...
                            <li>
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control md" name="company" placeholder="{{ __('○○○邸発電所') }}" value="{!! $carport->company !!}">
                                </div>
                            </li>
                            <li>
                                <div class="input-group">
                                    <label for="address" class="label">{{ __('設置場所') }}</label>
                                    <input type="text" class="form-control xs" name="address" placeholder="{{ __('東京都渋谷区千駄ヶ谷1-11-4') }}" value="{!! $carport->address !!}">
                                </div>
                            </li>
                            <li>
                                <div class="input-group">
                                    <label for="phone" class="label">{{ __('電話番号') }}</label>
                                    <input type="text" class="form-control sm" name="phone" placeholder="{{ __('03-5770-3690') }}" value="{!! $carport->phone !!}">
                                </div>
                            </li>
                            <li>
                                <div class="input-group">
                                    <label for="email" class="label">{{ __('メールアドレス') }}</label>
                                    <input type="email" class="form-control md" name="email" placeholder="{{ __('info@nin2.com') }}" value="{!! $carport->email !!}">
                                </div>
                            </li>
                            <li>
                                <div class="input-group">
                                    <label for="manager" class="label">{{ __('担当者') }}</label>
                                    <input type="text" class="form-control md" name="manager" placeholder="{{ __('山田太郎') }}" value="{!! $carport->manager !!}">
                                </div>
                            </li>
                            <li>
                                <div class="input-group">
                            ...
                            <li>
                                <div class="input-group">
                                    <label for="unit_price" class="label">{{ __('自家消費分販売電力単価') }}</label>
