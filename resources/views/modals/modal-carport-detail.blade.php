                                ...
                                <ul class="form-group">
                                    ...
                                    <li>
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control md" name="company" placeholder="{{ __('例）カーポート株式会社') }}" value="{!! $carport->company !!}">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-group">
                                            <label for="address" class="label">{{ __('設置場所') }}</label>
                                            <input type="text" class="form-control xs" name="address" placeholder="{{ __('例）茨城県水戸市千波町1950 ウェーブ21ビル2F') }}" value="{!! $carport->address !!}">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-group">
                                            <label for="phone" class="label">{{ __('電話番号') }}</label>
                                            <input type="text" class="form-control sm" name="phone" placeholder="{{ __('例）029-303-8581') }}" value="{!! $carport->phone !!}">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-group">
                                ...
                                <ul class="form-group">
                                    <li>
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control md" name="bill_name" placeholder="{{ __('例）カーポート株式会社') }}" value="{!! $carport->bill->name !!}">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-group">
                                            <label for="bill_zipcode" class="label">{{ __('請求先郵便番号') }}</label>
                                            <input type="text" class="form-control sd" name="bill_zipcode" placeholder="{{ __('例）310-0851') }}" value="{!! $carport->bill->zipcode !!}">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-group">
                                            <label for="bill_address1" class="label">{{ __('請求先住所1') }}</label>
                                            <input type="text" class="form-control xs" name="bill_address1" placeholder="{{ __('例）茨城県水戸市千波町1950') }}" value="{!! $carport->bill->address1 !!}">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-group">
                                            <label for="bill_address2" class="label">{{ __('請求先住所2') }}</label>
                                            <input type="text" class="form-control xs" name="bill_address2" placeholder="{{ __('例）ウェーブ21ビル2F') }}" value="{!! $carport->bill->address2 !!}">
                                        </div>
                                    </li>
                                </ul>
                            </div>
