...
$site_top = "https://carportclub.com/kaitori/";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "info@carportclub.com";

//自動返信メールの送信元メールアドレス
//必ず実在するメールアドレスでかつ出来る限り設置先サイトのドメインと同じドメインのメールアドレスとすることを強く推奨します
$from = "info@carportclub.com";
...
$Referer_check_domain = "carportclub.com";
...
$thanksPage = "https://carportclub.com/kaitori/thanks.php";
...
$require = array('お名前','Email','ご用件','ホームページ参照元');
...
$re_subject = "【自動返信】カーポート倶楽部買取りプラン";
...
カーポート倶楽部へのお問い合わせありがとうございました。
後程担当者より返信致しますので今しばらくお待ちください。
...
〒310-0851 茨城県水戸市千波町1950　
URL: https://carportclub.com/
Mail: info@carportclub.com
＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝
...
function mailToAdmin($arr,$subject,$mailFooterDsp,$mailSignature,$encode,$confirmDsp){
	...
	$adminBody .="「".$subject."」から見積申込みメールが届きました。\n\n";
	$adminBody .="＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝\n\n";
